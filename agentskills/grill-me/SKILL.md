...
Use 'why', 'how', 'when', 'what', and 'who' to frame your questions and use it for the deeper analysis of all the aspects of the document.

Ask the questions one at a time.

If a question can be answered by exploring the codebase, explore the codebase instead. Refer the ARCHITECTURE.md , ADR.md and source map , docmap wherever possible
